import 'package:charts/fl_chart.dart';
import 'package:charts/src/chart/base/line.dart';
...
void main() {
  ...
  group('drawSections()', () {
    test('test 1', () {
      ...
      final sections = [
        PieChartSectionData(
            gradient:
                LinearGradient(colors: [MockData.color2, MockData.color2]),
            radius: 30,
            value: 10,
    ...
    test('test 2', () {
      ...
      final PieChartData data = PieChartData(
          ...
          sections: [
            PieChartSectionData(
                gradient:
                    LinearGradient(colors: [MockData.color1, MockData.color1]),
                value: 1),
            PieChartSectionData(
                gradient:
                    LinearGradient(colors: [MockData.color2, MockData.color2]),
            ...
            PieChartSectionData(
                gradient:
                    LinearGradient(colors: [MockData.color3, MockData.color3]),
                value: 3),
            PieChartSectionData(
                gradient:
                    LinearGradient(colors: [MockData.color4, MockData.color4]),
                value: 4),
          ]);
  ...
  group('calculateCenterRadius()', () {
    test('test 1', () {
      ...
      final sections = [
        PieChartSectionData(
          gradient: LinearGradient(colors: [MockData.color1, MockData.color1]),
          value: 1,
          borderSide: MockData.borderSide1,
          showTitle: true,
        ...
        PieChartSectionData(
            ...
            title: '22-22'),
        PieChartSectionData(
          gradient: LinearGradient(colors: [MockData.color3, MockData.color3]),
          value: 3,
          borderSide: MockData.borderSide3,
          showTitle: false,
        ...
        PieChartSectionData(
          gradient: LinearGradient(colors: [MockData.color4, MockData.color4]),
          value: 4,
          borderSide: MockData.borderSide4,
          showTitle: true,
