...
class MockData {
  ...
  static final pieChartSection0 = PieChartSectionData(
    value: 0,
    gradient: LinearGradient(colors: [color0, color0]),
    radius: 0,
  );

  static final pieChartSection1 = PieChartSectionData(
    value: 1,
    gradient: LinearGradient(colors: [color1, color1]),
    radius: 1,
  );

  static final pieChartSection2 = PieChartSectionData(
    value: 2,
    gradient: LinearGradient(colors: [color2, color2]),
    radius: 2,
  );

  static final pieChartSection3 = PieChartSectionData(
    value: 3,
    gradient: LinearGradient(colors: [color3, color3]),
    radius: 3,
  );

  static final pieChartSection4 = PieChartSectionData(
    value: 4,
    gradient: LinearGradient(colors: [color4, color4]),
    radius: 4,
  );
...
final PieChartData pieChartData1 = PieChartData(
  ...
  sections: [
    PieChartSectionData(
        value: 12, gradient: LinearGradient(colors: [Colors.red, Colors.red])),
    PieChartSectionData(
        value: 22,
