...
import 'package:dbb_flutter_client/common/charts/src/chart/base/line.dart';
...
class PieChartPainter extends BaseChartPainter<PieChartData> {
  ...
  void drawSections(
    ...
    for (var i = 0; i < data.sections.length; i++) {
      ...
      if (sectionDegree == 360) {
        _sectionPaint.shader = section.gradient!.createShader(
            Rect.fromCircle(center: center, radius: section.radius));
  ...
  void drawSection(PieChartSectionData section, Path sectionPath,
      CanvasWrapper canvasWrapper) {
    _sectionPaint.shader =
        section.gradient!.createShader(sectionPath.getBounds());
